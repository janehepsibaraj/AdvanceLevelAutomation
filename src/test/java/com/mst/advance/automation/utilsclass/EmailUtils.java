package com.mst.advance.automation.utilsclass;
...
public class EmailUtils {
	 ...
	 private Folder folder;
	  ...
	  public EmailUtils(String username, String password, String server, EmailFolder emailFolder) throws MessagingException {
	    ...
	    try {
	      props.load(new FileInputStream(new File("C:\\Users\\MSTSYS\\eclipse-workspace\\Advanceautomationlearning\\src\\test\\resources\\properties.file")));
	    } catch(Exception e) {
	      e.printStackTrace();
	      System.exit(-1);
	    }
